...
const statusLabels: Record<RegistrationStatus, string> = {
  pending_payment: 'Pagamento em confirmação',
      ...
      .then((registration) => {
        ...
        setMessage(
          registration.status === 'paid'
            ? 'Pagamento aprovado. Sua inscrição está confirmada.'
            : 'Recebemos o retorno do checkout. A confirmação final depende do processamento do pagamento pela InfinitePay.',
        );
      })
      .catch((error) => {
