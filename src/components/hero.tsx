  ...
  return (
    <section className="relative flex flex-col justify-start overflow-hidden px-4 pb-10 pt-10 sm:px-6 sm:pb-16 sm:pt-20 md:min-h-[92svh] md:justify-end md:pb-24">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-start overflow-visible">
        <motion.h1
          className="max-w-[calc(100vw-2rem)] overflow-visible px-1 py-2 font-display text-[clamp(3.50rem,16vw,7.5rem)] font-black uppercase leading-[0.9] tracking-tighter text-white sm:max-w-[calc(100vw-3rem)] sm:text-[clamp(4.25rem,8vw,8.75rem)] md:leading-[0.86]"
