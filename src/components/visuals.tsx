  ...
  return (
    <section id="map" className="relative scroll-mt-24 overflow-hidden border-t border-zinc-900 bg-zinc-950 px-4 py-16 sm:px-6 md:py-24 lg:py-32">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 lg:flex-row lg:gap-20 xl:gap-24">
        <div className="flex w-full min-w-0 flex-col gap-6 lg:w-1/3">
        ...
        <div className="group relative aspect-[4/3] w-full overflow-hidden rounded-sm border-2 border-zinc-800 bg-zinc-900 sm:aspect-video lg:w-2/3">
          ...
          <div className="absolute left-1/4 top-1/2 z-20 h-4 w-4 rounded-full bg-brand shadow-[0_0_15px_#dfff00] animate-pulse" />
          ...
          <div className="absolute bottom-3 left-3 right-3 z-30 border border-zinc-800 bg-black/80 p-3 backdrop-blur sm:bottom-6 sm:left-auto sm:right-6 sm:p-4">
...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="scroll-mt-24 overflow-hidden border-t border-zinc-900 bg-black py-16 md:py-24" ref={containerRef}>
      <div className="mx-auto mb-10 flex max-w-7xl items-end justify-between px-4 sm:px-6 md:mb-16">
        <div>
      ...
      <div className="flex h-[420px] w-full items-center justify-center gap-3 overflow-hidden px-4 sm:h-[520px] md:h-[70vh] md:gap-8 md:px-8 lg:h-[80vh]">
        <motion.div className="flex h-[135%] w-1/2 flex-col gap-3 md:h-[150%] md:w-1/3 md:gap-4" style={{ y: y1 }}>
          <img src={images[0]} alt="Runner" className="h-1/2 w-full object-cover object-center grayscale transition-all duration-500 hover:grayscale-0" loading="lazy" decoding="async" />
          <img src={images[1]} alt="Shoes" className="h-1/2 w-full object-cover grayscale transition-all duration-500 hover:grayscale-0" loading="lazy" decoding="async" />
        </motion.div>

        <motion.div className="flex h-[135%] w-1/2 flex-col gap-3 md:h-[150%] md:w-1/3 md:gap-4" style={{ y: y2 }}>
          <img src={images[2]} alt="Group running" className="h-[58%] w-full object-cover grayscale transition-all duration-500 hover:grayscale-0" loading="lazy" decoding="async" />
          <img src={images[3]} alt="City Runner" className="h-[42%] w-full object-cover object-top grayscale transition-all duration-500 hover:grayscale-0" loading="lazy" decoding="async" />
        </motion.div>
      </div>
    </section>
  );
