...
//
// ADMIN-UX-RELIABILITY Wave 3A: 19 -> 17. handleAdminEventUpdate and
// handleAdminDistanceUpdate delegate to the narrow
// updateEventConfigurationInPostgres / updateDistanceConfigurationInPostgres
